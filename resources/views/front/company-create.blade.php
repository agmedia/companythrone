                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ localized_route('companies.store') }}" class="vstack gap-3">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label" for="oib">{{ __('company.oib') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input id="street" name="street" class="form-control  form-control-lg" value="{{ old('street') }}" required>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label" for="street_no">{{ __('company.street_no') }} <span class="text-danger">*</span></label>
                                    <input id="street_no" name="street_no" class="form-control  form-control-lg" value="{{ old('street_no') }}" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label" for="city">{{ __('company.city') }} <span class="text-danger">*</span></label>
                                    <input id="city" name="city" class="form-control  form-control-lg" value="{{ old('city') }}" required>
                                </div>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-6">
