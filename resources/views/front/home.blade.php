...
@section('content')
    ...
    <section class= "bg-body-tertiary py-2 py-sm-3 py-md-4 py-lg-5 mb-0">
        ...
        <p class="fs-lg pb-3">
            Companythrone vam pomaže izgraditi snažan online identitet kako biste privukli više klijenata i brže rasli. Pretvorite svoju online prisutnost u najsnažniji poslovni alat.
        </p>
        <hr class="mb-4">
          ...
          "slidesPerView": 3
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <h3 class="h5 pt-3 pt-md-4 mb-2">Istražite</h3>
                    <p class="mb-0">
                        Pretražujte našu bazu tvrtki po nazivu, ključnim riječima ili OIB-u. Svaka tvrtka ima svoju stranicu s logotipom i poveznicom, tako da možete brzo upoznati ponudu i pronaći prave partnere.
                    </p>
                </div>
                ...
                <div class="swiper-slide">
                    ...
                    <h3 class="h5 pt-3 pt-md-4 mb-2">Dodajte tvrtku</h3>
                    <p class="mb-0">
                        Ispunite jednostavan obrazac s osnovnim podacima i učitajte svoj logotip kako biste bili vidljiviji.
                    </p>
                </div>
                ...
                <div class="swiper-slide">
                    ...
                    <h3 class="h5 pt-3 pt-md-4 mb-2">Primajte posjete</h3>
                    <p class="mb-0">
                        Svakodnevnim posjećivanjem preporučenih stranica održavate svoju poveznicu aktivnom. Sustav rotira poveznice kroz više razina i ravnomjerno raspoređuje posjete, čime vaša web stranica može ostvariti značajan rast prometa.
                    </p>
                </div>
            </div>
