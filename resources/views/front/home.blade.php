          ...
          "slidesPerView": 3
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <p class="mb-0">
                        Ispuni jednostavan obrazac s osnovnim podacima i učitaj logotip. Nakon godišnje uplate od {{ app_settings()->getPrice() }} € tvoj logo postaje vidljiv. Preporuči najmanje pet drugih tvrtki kako bi aktivirao svoj profil i poveznicu.
                    </p>
                </div>
