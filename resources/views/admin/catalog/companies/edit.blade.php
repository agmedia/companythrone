...
@php
    ...
    $title = $isEdit
        ? ('Edit company: ' . ($company->translations->firstWhere('locale', app()->getLocale())->name ?? $company->id))
        : 'Create company';
        ...
        <div class="col-12 col-lg-10">
            <form action="{{ $action }}" method="POST" class="card" enctype="multipart/form-data">
                ...
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('catalog.companies.index') }}" class="btn btn-light">Back</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="is_link_active">Link active</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label d-flex align-items-center justify-content-between">
                            <span class="me-3">Translations</span>

                            {{-- Locale pills (canonical: config('app.locales')) --}}
                                ...
                                <div id="company-lang-{{ $code }}" class="tab-pane fade @if ($code == $current) show active @endif">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               autocomplete="off">
                                        <div class="form-text">Auto-populates from Name; možeš urediti.</div>
                ...
                <div class="card-footer d-flex gap-2">
                    ...
                    <a href="{{ route('catalog.companies.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
