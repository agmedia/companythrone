    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td style="padding: 20px 0 15px 0; text-align: center">
                <label class="large bold" style="color: white;">   <img src="{{ asset('admin/theme1/assets/images/logo-dark.svg') }}" alt="CompanyThrone.com" border="0" style="max-width:300px;height: auto;"></label>
            </td>
        </tr>
        <!-- Email Header : END -->
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
        <tr>
            <td style="padding: 20px;  font-size: 12px; line-height: 15px; text-align: center; color: #373f50;">
                CompanyThrone © {{ now()->year }}. {{ __('Sva prava pridržana') }}. <br><a href="info/uvjeti-prodaje" style="color:#ffffff;">{{ __('front/cart.opci_uvjeti') }}</a>
                <br>
            </td>
        </tr>
    </table>
