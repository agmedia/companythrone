...
<header class="navbar navbar-expand-lg bg-body navbar-sticky sticky-top z-fixed px-0" data-sticky-element>
    <div class="container">
        ...
        <div class="d-flex gap-sm-1">
            ...
            <!-- Join button  -->
            <a class="btn btn-primary animate-scale" href="{{ localized_route('companies.create') }}l">
                <i class="fi-plus fs-lg animate-target ms-n2 me-1 me-sm-2"></i>
                Join<span class="d-none d-xl-inline ms-1">{{ config('app.name','Companythrone') }}</span>
            </a>
        </div>
    </div>
</header>