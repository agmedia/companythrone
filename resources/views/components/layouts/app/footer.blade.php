    ...
    <div class="container pb-md-2">
        ...
        <div class="d-md-flex align-items-center py-4 pt-sm-5 mt-3 mt-sm-0">
            <div class="d-flex gap-2 gap-sm-3 justify-content-center ms-md-auto mb-4 mb-md-0 order-md-2">
                <div>
                    <img src="{{ asset('theme1/assets/img/payment-methods/visa-dark-mode.svg') }}" alt="Visa">
                </div>
                <div>
                    <img src="{{ asset('theme1/assets/img/payment-methods/mastercard.svg') }}" alt="Mastercard">
                </div>
                <div>
                    <img src="{{ asset('theme1/assets/img/payment-methods/paypal-dark-mode.svg') }}" alt="PayPal">
                </div>
                <div>
                    <img src="{{ asset('theme1/assets/img/payment-methods/google-pay-dark-mode.svg') }}" alt="Google Pay">
                </div>
                <div>
                    <img src="{{ asset('theme1/assets/img/payment-methods/apple-pay-dark-mode.svg') }}" alt="Apple Pay">
                </div>
            </div>
            <p class="text-body-secondary fs-sm text-center text-md-start mb-0 me-md-4 order-md-1">&copy; All rights reserved. Made by <a class="text-body fw-medium text-decoration-none hover-effect-underline" href="https://createx.studio/" target="_blank" rel="noreferrer">Createx Studio</a></p>
        </div>
    </div>
</footer>